...
const Chart = () => {
    ...
    useEffect(() => {
        setIsLoading(true);
        axios.get(`http://localhost:3000/getuserConsoomData/${user.ID_D.toString()}`)
            .then((res) => {
    ...
    const applyFilters = () => {
        ...
        let apiUrl = `http://localhost:3000/getuserConsoomData/${user.ID_D.toString()}`;
        ...
        <>
            ...
            <form onSubmit={handleSubmit}>
                <div className="flex items-center justify-center my-4">
                    ...
                    <button type="submit"
                            className="bg-blue-500 text-white p-2 rounded hover:bg-blue-300 transition-all duration-500 ">Apply
                        Filters
                    </button>
                </div>
            </form>
